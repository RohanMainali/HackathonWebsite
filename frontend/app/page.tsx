...
export default function HomePage() {
  ...
  return <main id="main-content">
    <section className="hero">
      ...
      <Container className="hero__content"><p className="eyebrow">HACKATHON STRATEGY / PRODUCTION / COMMUNITY</p><h1>From first brief<br />to final <em>demo.</em></h1><p className="hero__intro">We design and run high-impact hackathons for institutions, companies, and communities—bringing together the strategy, people, production, and follow-through needed to make the event work.</p><div className="cta-row"><ButtonLink href="/contact">Plan a hackathon</ButtonLink><ButtonLink href="/work" variant="light">See our work</ButtonLink></div><p className="hero__proof">National and international experience <span>·</span> In-person, hybrid, and online</p></Container>
    </section>
