...
export default function HomePage() {
  ...
  return <main id="main-content">
    ...
    <section className="section audiences-section"><Container><SectionHeader title="Designed around the institution. Built for the people in the room." /><ol className="audience-list">{audienceDetails.map(([title, description], index) => <li key={title}><span>0{index + 1}</span><div><h3>{title}</h3><p>{description}</p></div></li>)}</ol></Container></section>
