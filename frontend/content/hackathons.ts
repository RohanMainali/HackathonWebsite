...
export const hackathons: Hackathon[] = [
  {
    slug: "deep-learning-codefest",
    title: "Deep Learning Codefest",
    year: "2024",
    date: "July 7, 2024",
    ...
    location: "Aranya Boutique Hotel, Shivapuri Block, Kathmandu",
    ...
    brief: "The challenge invited students to move beyond classroom theory, apply deep-learning knowledge to a real-world problem, demonstrate their technical ability and build practical AI and machine-learning experience in a competitive setting.",
    ...
    coverImage: {
      ...
      alt: "Student teams working at laptops throughout the Deep Learning Codefest venue",
      caption: "The 10-hour Deep Learning Codefest at Aranya Boutique Hotel",
      fallbackLabel: "Deep Learning Codefest venue",
      aspect: "landscape",
      color: "blue",
    },
    gallery: [
  ...
  {
    slug: "turboline-hackathon-2025",
    title: "Turboline Hackathon 2025",
    year: "2025",
    ...
    coverImage: {
      ...
      alt: "Teams working across the Turboline Hackathon event floor",
      caption: "57 teams building across a 72-hour hybrid innovation sprint",
      fallbackLabel: "Turboline Hackathon event floor",
      aspect: "landscape",
      color: "orange",
    },
    gallery: [
      ...
      { src: "/images/hackathons/turboline-iims-2025/day-one-team.jpg", alt: "A participant team standing in front of the Turboline Hackathon backdrop", caption: "International collaboration shaped the three-day experience", fallbackLabel: "Day one team", aspect: "wide", color: "orange" },
      ...
      { src: "/images/hackathons/turboline-iims-2025/finalists.jpg", alt: "Hackathon participants and organizers gathered in Kathmandu", caption: "A three-day community spanning eight nations and 19 institutions", fallbackLabel: "Hackathon community", aspect: "landscape", color: "mint" },
    ...
    outcomes: [
      ...
      { title: "1st runner-up: Hacktastic", description: "Anuj Bhandari, Prabin Joshi and Sujal Maharjan secured first runner-up." },
      { title: "2nd runner-up: Silver", description: "Rohan Mainali and Neha Aryal secured second runner-up." },
  ...
  {
    slug: "perceptron-international-hackathon-2026",
    title: "Perceptron International Hackathon 2026",
    year: "2026",
    ...
    location: "Aranya Boutique Hotel, Kathmandu",
    ...
    timeline: [
      ...
      { label: "Showcase", description: "Finalists demonstrated their systems and explained their impact to the judging panel." },
    ...
    coverImage: {
      ...
      alt: "A room-wide view of teams and an expert session at the Perceptron International Hackathon 2026",
      caption: "Teams learning and building together across the 48-hour AI sprint",
      fallbackLabel: "Perceptron International Hackathon",
      aspect: "landscape",
      position: "center 48%",
      color: "yellow",
    },
    gallery: [
      ...
      { src: "/images/hackathons/iims-perceptron-2026/second-runner-up-futstats.jpg", alt: "Team FutStats holding the second runner-up cheque", caption: "Second runner-up: FutStats", fallbackLabel: "Second runner-up FutStats", aspect: "landscape", color: "mint" },
    ],
    outcomes: [
      ...
      { title: "2nd runner-up: FutStats", description: "Nishan Maharjan, Pragyan Shrestha and Rojit Khadgi secured second runner-up." },
